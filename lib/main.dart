...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String localIp = "10.154.200.49"; //TODO Change ip

  //Send data to backend
  Future<Response> sendData(String name, double tokenAmount) {
    print(name + " " + tokenAmount.toString());
    return post(
      Uri.parse('http://' + localIp + ':3001/building/deploy'), //REMEMBER TO CHANGE IP ADDRESS
  ...
  Future<Response> sendData2(String name, double tokenAmount) async {
    print(name + " " + tokenAmount.toString());

    Response rsp = await sendData(name, tokenAmount);
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return const BuySellPage(title: 'Buy / Sell');
                  }));
                },
