...
import 'package:dstate/transaction_tester.dart';
import 'package:walletconnect_dart/walletconnect_dart.dart';
import 'package:dart_web3/src/crypto/secp256k1.dart';
import 'package:dart_web3/dart_web3.dart';
//Code adapted from skd usage example
...
class EthereumTransactionTester extends TransactionTester {
  ...
  Future<SessionStatus> connect({OnDisplayUriCallback? onDisplayUri}) async {
    return connector.connect(chainId: 4, onDisplayUri: onDisplayUri); //Rinkeby is 4, Ethereum is 1
  }
